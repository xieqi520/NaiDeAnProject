...
#define CodecType AVMediaType_FFMPEG
...
typedef struct AVCodecContext {
    ...
    enum AVMediaType_FFMPEG codec_type; /* see AVMEDIA_TYPE_xxx */
 ...
 */
enum AVMediaType_FFMPEG avcodec_get_type(enum AVCodecID codec_id);
