...
import com.lib.zxing.decoding.CaptureActivityHandler;
import com.lib.zxing.decoding.InactivityTimer;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private synchronized void switchFlash(boolean flag) {
        Camera camera = CameraManager.get().getCamera();
        Camera.Parameters parameters = camera.getParameters();
        List supportedFlashModes = parameters.getSupportedFlashModes();
        //这里使用supportedFlashModes判断是否支持闪光灯的情况,如果支持，设置为关闭; 如果不支持，什么都不做
