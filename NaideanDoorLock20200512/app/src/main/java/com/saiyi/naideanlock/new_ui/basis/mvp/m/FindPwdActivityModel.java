...
public class FindPwdActivityModel extends BaseModel {
    public void findPwd(final int code, String phone,String password,String phoneCode, final OnLoadHttpDataListener listener){
        ...
        HttpDataBasis.getInstance().findPwd(body, new Observer<MdlBaseHttpResp>() {
            @Override
